...
import { Moon, Sun, Calendar, Upload, FileText, CheckCircle2, Clock, AlertCircle, Sparkles, X, BookOpen, Skull } from 'lucide-react';
import { useLanguage } from '../context/LanguageContext';

interface PakshaDaySelectorProps {
  selectedPaksha: PakshaType;
  selectedDay: DayOfWeek;
  onSelectPakshaAndDay: (paksha: PakshaType, day: DayOfWeek) => void;
